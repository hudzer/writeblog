<?php
if (!function_exists('write_blog_get_localized_variables')) :
    /**
     ...
     */
    function write_blog_get_localized_variables(){

        /*For Slider*/
        $args['enable_slider_nav'] = write_blog_get_option('enable_slider_below_nav', true);
        $args['enable_slider_loop'] = write_blog_get_option('enable_slider_loop', true);
        /**/

        /*For Masonry*/
        $args['masonry_animation'] = write_blog_get_option('masonry_animation', true);
        $args['relayout_masonry'] = write_blog_get_option('relayout_masonry', true);
        /**/
