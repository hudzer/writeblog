<?php
if ( ! function_exists( 'write_blog_is_preloader_enabled' ) ) :
     ...
     */
    function write_blog_is_preloader_enabled( $control ) {
...
if ( ! function_exists( 'write_blog_is_banner_slider_enabled' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function write_blog_is_banner_slider_enabled( $control ) {
...
if ( ! function_exists( 'write_blog_is_ft_cats_enabled' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function write_blog_is_ft_cats_enabled( $control ) {
...
if ( ! function_exists( 'write_blog_is_full_grid_enabled' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function write_blog_is_full_grid_enabled( $control ) {
...
if ( ! function_exists( 'write_blog_is_contact_info_enabled' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function write_blog_is_contact_info_enabled( $control ) {
...
if ( ! function_exists( 'write_blog_is_related_posts_enabled' ) ) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function write_blog_is_related_posts_enabled( $control ) {
