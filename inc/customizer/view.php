...
if ( ! function_exists( 'write_blog_get_option' ) ) :
    /**
     ...
     */
    function write_blog_get_option($key, $defaults = false) {
        ...
        if( true == $defaults && 'unset' === $key_value ){
            $default_values = write_blog_get_default_customizer_values();
...
if ( ! function_exists( 'write_blog_get_options' ) ) :
    /**
     ...
     */
    function write_blog_get_options() {
        $default_values = write_blog_get_default_customizer_values();
        $customizer_values = get_theme_mod( 'theme_options' );
