 ...
 * @return array Files.
 */
function write_blog_import_files() {
    return array(
        array(
            'import_file_name'             =>  esc_html__( 'Theme Demo Content', 'write-blog' ),
            'local_import_file'            => trailingslashit( get_template_directory() ) . 'demo-data/write-blog.xml',
            'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'demo-data/write-blog.wie',
            'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'demo-data/write-blog.dat',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'write_blog_import_files' );
...
function write_blog_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'write_blog_after_import_setup' );